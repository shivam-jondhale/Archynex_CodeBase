...
const ProjectManager = ({ isOpen, onClose }) => {
  ...
  const handleDeleteProject = (project) => {
    if (!user) {
      toast.error("Please login to delete projects");
      router.push("/login");
      return;
    }
  ...
  const handleImportProject = (event) => {
    if (!user) {
      toast.error("Please login to import projects");
      router.push("/login");
      return;
    }
    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-white dark:bg-gray-900 rounded-xl shadow-2xl w-full max-w-4xl h-[80vh] flex flex-col border border-gray-200 dark:border-gray-700"
        >
          {/* Header */}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {projects.map((project) => (
                  <motion.div
                    ...
                    className={`
                      bg-white dark:bg-gray-800 border rounded-lg p-4 hover:shadow-md transition-all cursor-pointer
                  ...
                  >
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <button
                        ...
                        className="p-2 hover:bg-red-100 dark:hover:bg-red-900/30 rounded-md transition-colors ml-auto"
