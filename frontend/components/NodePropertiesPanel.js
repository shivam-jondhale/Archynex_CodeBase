  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="fixed right-0 top-0 h-full w-80 bg-white dark:bg-gray-900 shadow-2xl border-l border-gray-200 dark:border-gray-700 z-40 overflow-y-auto"
      >
        {/* Header */}
        <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
          ...
          <h3 className="font-semibold text-gray-800 dark:text-white">Properties</h3>
        </div>
              ...
              <div className="grid grid-cols-5 gap-2">
                {colorOptions.map((color) => (
                  <button
                    ...
                    className={`w-8 h-8 rounded-lg border-2 transition-all ${nodeData.color === color
